...
class simple_kinematics:
    def __init__(self):
        ...
        self.motor_pub =rospy.Publisher("sensors/core",Float64,queue_size=1)
    ...
    while not rospy.is_shutdown
        if self.is_servo ==True and self.is_speed ==True:
            print(self.speed,self.steering_angle_to_servo_rad*180/pi)
            ...
            self.theta_dot=self.theta+theta_dot
